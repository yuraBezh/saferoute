export const caregiverText = {
	...
	pendingVerificationTitle: 'Your profile is pending verification',
	verificationPrototypeExplanation:
		"In the full product an administrator reviews your driver's licence, insurance and background check before you can accept bookings. That review flow is out of scope for this prototype.",
	verifyLabel: 'Verify my profile (demo)',
	verifyingLabel: 'Verifying…',
	cannotSelfVerifyError: 'Your profile can no longer be verified from this page.',
	saveError: 'Unable to verify your profile. Please try again.',
	unavailableTitle: 'Caregiver profile required',
	unavailableDescription: 'Complete your caregiver profile before viewing assignments.',
